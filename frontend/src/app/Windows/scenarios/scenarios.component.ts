...
/**
  ...
  navigateTo(path: string): void {
    this.router.navigate([`/dashboard/scenarios/${path}`]);
  }
  ...
  isRootSubRoute(): boolean {
    return this.router.isActive('/dashboard/scenarios', true); 
  }
   ...
   */
  newScenario(): void {
    this.router.navigate(['/dashboard/scenarios/new-scenario']);
  }
  ...
  viewTimelineAD(uuid: string) {
    this.router.navigate([`/dashboard/scenarios/${uuid}/timeline-ad`]);
  }
  ...
  viewMetrics(uuid: string) {
    this.router.navigate([`/dashboard/scenarios/${uuid}/metrics`]);
  }
  ...
  production(uuid: string) {
    this.router.navigate([`/dashboard/scenarios/${uuid}/production`]);
  }
   ...
   * 
   * @returns Sorted array of scenarios
   */
  sortScenariosByDate() {
  ...
  editScenario(uuid: string): void {
    this.router.navigate([`/dashboard/scenarios/edit-scenario/${uuid}`]);
  }
