...
CREATE TABLE `AnomalyMetric` (
  ...
  `anomaly_image` varchar(100) DEFAULT NULL,
  `global_shap_image` varchar(100) DEFAULT NULL,
  `local_shap_image` varchar(100) DEFAULT NULL,
  `global_lime_image` varchar(100) DEFAULT NULL,
  `local_lime_image` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=3693 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `User` VALUES (27,'pbkdf2_sha256$600000$XEt2qBlXsM83caz6S6lj7b$iOoKYZhVB4IwPXp3ga7wo2dZTYSWS1yJiC3Y2eX8bmo=','2025-06-26 09:55:21.810776',1,'edulb96','Eduardo','Lopezq','eduardo.lopez5@um.es',1,1,'2025-06-11 15:41:07.523510','edulb96',42,57,10,5),(28,'pbkdf2_sha256$600000$0WPp86ncXEmfmfp5X8wyQi$tyeDcHSL3/i44neQKHI8Z3htiyRAdfH0IijAe/a0YMw=','2025-06-26 10:05:55.934205',1,'defender2025','Defender','Project','edujumi96@gmail.com',1,1,'2025-06-26 10:00:08.546090','edulb96',0,0,1,0);
...
-- Dump completed on 2025-06-26 10:08:35
