...
- Usa tus funciones `prueba_packet` y `prueba_flow` tal cual si están disponibles.
...
Requisitos:
- Tener `prueba_packet` y/o `prueba_flow` accesibles en el import path del proceso
...
# =============================================================================
_HANDLER_PACKET_NAME = "prueba_packet"   # o "handle_packet_prediction"
_HANDLER_FLOW_NAME   = "prueba_flow"     # o "handle_flow_prediction"
...
def prueba_packet(proc, pipelines, scenario_model, design, config, execution, uuid, scenario):
    """
...
def prueba_flow(proc, pipelines, scenario_model, design, config, execution, uuid, scenario):
    """
